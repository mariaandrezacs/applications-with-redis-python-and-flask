...
from .interfaces.redis_repository import RedisRepositoyInterface


class RedisRepositoy(RedisRepositoyInterface):
    ...
    def insert_ex(self, key: str, value: any, ex: int) -> None:
        self.__redis_conn.set(key, value, ex)

    def insert_hash_ex(self, key: str, field: str, value: str, ex: int) -> None:
        self.__redis_conn.hset(key, field, value)
